...
namespace Arrecadar3.Controllers
{
    public class DoacaosController : Controller
    {
        ...
        public DoacaosController(Arrecadar3Context context)
        {
            _context = context;
        }
        ...
        {
            var arrecadar3Context = _context.Doacao.Include(d => d.Campanha);
        ...
        {
            if (id == null || _context.Doacao == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> Create([Bind("Id,CampanhaId,Valor_Doado,Data")] Doacao doacao)
        {
            ...
            ViewData["CampanhaId"] = new SelectList(_context.Campanha, "Id", "Titulo", doacao.CampanhaId);
            return View(doacao);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,CampanhaId,Valor_Doado,Data")] Doacao doacao)
        {
            if (id != doacao.Id)
            {
                return NotFound();
        ...
        {
            if (_context.Doacao == null)
            {
                return Problem("Entity set 'Arrecadar3Context.Doacao'  is null.");
            }
            var doacao = await _context.Doacao.FindAsync(id);
            if (doacao != null)
            {
        ...
        {
          return (_context.Doacao?.Any(e => e.Id == id)).GetValueOrDefault();
        }
    }
}
